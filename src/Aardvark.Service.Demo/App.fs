...
//                    //do! Async.SwitchToNewThread()
//                    while true do
//                        let handlers = lock state (fun () -> state.timeHandlers |> Dictionary.toList)
//                        let messages =
//                            handlers |> List.collect (fun (_,h) ->
//                                h V2i.Zero noCamera DateTime.Now
//                            )
//
//                        emit messages
//                        do! Async.Sleep 10
