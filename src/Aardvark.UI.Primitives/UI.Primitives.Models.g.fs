...
module Mutable =
    ...
    type MNumericBox private(__initial : Aardvark.UI.NumericBox) =
        ...
        member x.Update(__model : Aardvark.UI.NumericBox) =
    ...
    module NumericBox =
        ...
        module Lens =
            let value =
                { new Lens<Aardvark.UI.NumericBox, Microsoft.FSharp.Core.float>() with
            ...
            let format =
                { new Lens<Aardvark.UI.NumericBox, Microsoft.FSharp.Core.string>() with
